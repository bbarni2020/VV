...
socket.on('auth_failed', () => {
    ...
    console.log('Cleared stored credentials, will request new authentication on next connect');
});
...
export { sendPlayerAction, sendPlayerInfo, playerId, socket, getAuthenticationStatus };